...
describe("Test cliParser", () => {
    ...
    describe("Test parseCommand", () => {
        it("should parse default flags", async () => {
            ...
            const { projectName, verbose, typescript, icon } = await parseCommand(["node.exe", "dummy.ts", sandbox]);
        ...
        it("should parse flags: --no-typescript", async () => {
            ...
            const { projectName, verbose, typescript, icon } = await parseCommand(["node.exe", "dummy.ts", sandbox, "--no-typescript"]);
        ...
        it("should parse flags: --verbose", async () => {
            ...
            const { projectName, verbose, typescript, icon } = await parseCommand(["node.exe", "dummy.ts", sandbox, "--verbose"]);
        ...
        it("should parse flags: --icon", async () => {
            ...
            const { projectName, verbose, typescript, icon } = await parseCommand(["node.exe", "dummy.ts", sandbox, "--icon", iconLocation]);
        ...
        it("should not fail if no projectName and interactive", async () => {
            ...
            const { projectName, verbose, typescript, icon } = await parseCommand(["node.exe", "dummy.ts", "--interactive"]);
